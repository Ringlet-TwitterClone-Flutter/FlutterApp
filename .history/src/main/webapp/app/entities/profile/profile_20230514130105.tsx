...
export const Profile = () => {
  ...
  return (
    <div>
      ...
      <span id="user">Current User: {currentUser.login}</span> 
      <br />
      <span>First Name: {currentUser.login} </span> 
      <br />
      <span>Last Name: {currentUser.login}</span>
      <br />
      <span>Current ID: {currentUser.login}</span>
      </div>
